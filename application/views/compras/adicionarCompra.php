                        ...
                        <div class="tab-pane active" id="tab1">
                            <div class="span12" id="divCadastrarOs">
                                <?php if ($custom_error == true) { ?>
                                    <div class="span12 alert alert-danger" id="divInfo" style="padding: 1%;">Dados incompletos, verifique os campos com asterisco ou se selecionou corretamente fornecedor/cliente e responsável.</div>
                                <?php } ?>
                                <form action="<?php echo site_url('compras/adicionar'); ?>" method="post" id="formCompras">
                                    <div class="span12" style="padding: 1%">
                                        <div class="span2">
                                            <label for="dataCompra">Data da Compra<span class="required">*</span></label>
                                            <input id="dataCompra" class="span12 datepicker" type="text" name="dataCompra" value="<?php echo date('d/m/Y'); ?>"/>
                                        </div>
                                        <div class="span3">
                                            <label for="cliente">Fornecedor/Cliente<span class="required">*</span></label>
                                            ...
                                            <div class="addclient"><?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'aCliente')) { ?>
                                              <a href="<?php echo base_url(); ?>index.php/clientes/adicionar" class="btn btn-success"><i class="fas fa-plus"></i> Adicionar Fornecedor/Cliente</a><?php } ?></div>
                                        </div>
                                        <div class="span3">
                                    ...
                                    <div class="span6" style="padding: 1%; margin-left: 0">
                                        <label for="observacoes_cliente">
                                            <h4>Observações para o Fornecedor/Cliente</h4>
                                        </label>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span6 offset3" style="display:flex;justify-content: center">
                                          <button class="button btn btn-success" id="btnContinuar"><span class="button__icon"><i class='bx bx-chevrons-right'></i></span><span class="button__text2">Continuar</span></button>
                                            <a href="<?php echo base_url() ?>index.php/compras" class="button btn btn-mini btn-warning"><span class="button__icon"><i class="bx bx-undo"></i></span> <span class="button__text2">Voltar</span></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // ui-datepicker-div
        $(".datepicker").datepicker('widget').css('z-index', 1000);
        $('.editor').trumbowyg({
            lang: 'pt_br'
        });
        $('.addclient').hide();
