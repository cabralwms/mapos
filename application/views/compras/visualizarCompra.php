            ...
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <div class="buttons">
                    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eCompra')) {
                        echo '<a title="Editar Compra" class="button btn btn-mini btn-success" href="' . base_url() . 'index.php/compras/editar/' . $result->idCompras . '">
    <span class="button__icon"><i class="bx bx-edit"></i> </span> <span class="button__text">Editar</span></a>';
                    } ?>
                    <a target="_blank" title="Imprimir Papel A4" class="button btn btn-mini btn-inverse" href="<?php echo site_url() ?>/compras/imprimir/<?php echo $result->idCompras; ?>">
                        <span class="button__icon"><i class="bx bx-printer"></i></span> <span class="button__text">Papel A4</span></a>
                    <a target="_blank" title="Imprimir Cupom Não Fiscal" class="button btn btn-mini btn-inverse" href="<?php echo site_url() ?>/compras/imprimirTermica/<?php echo $result->idCompras; ?>">
                ...
                <div class="invoice-content">
                    ...
                    <div style="margin-top: 0; padding-top: 0">
                        <table class="table table-condensed">
                            <tbody>
                                <?php if ($result->dataCompra != null) { ?>
                                    <tr>
                                        <td>
                                            <b>Status Compra: </b><?php echo $result->status ?>
                                        </td>

                                        <td>
                                            <b>Data da Compra: </b><?php echo date('d/m/Y', strtotime($result->dataCompra)); ?>
                                        </td>
