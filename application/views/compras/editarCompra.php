                            ...
                            <div class="span12 well" style="padding: 1%; margin-left: 0">
                                <div class="span11">
                                    <form id="formProdutos" action="<?php echo base_url(); ?>index.php/compras/adicionarProduto" method="post">
                                        ...
                                        <div class="span2">
                                            <label for="">Sku</label>
                                            <input type="text" placeholder="sku" id="sku" name="sku" class="span12" />
                                        </div>
                                        <div class="span2">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach ($produtos as $p) {
                                        ...
                                        echo '<td><div align="center"><input type="number" class="form-control" name="quantidade[]" value="' . $p->quantidade . '"></div></td>';
    ...
    <form id="formFaturar" action="<?php echo current_url() ?>" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="span12" style="margin-left: 0">
                ...
                <input class="span12" id="descricao" type="text" name="descricao" value="Fatura de Compra Nº: <?php echo $result->idCompras; ?> " />
            </div>
            <div class="span12" style="margin-left: 0">
                <div class="span12" style="margin-left: 0">
        ...
        $(document).on('click', 'a', function(event) {
            ...
            if ((idProduto % 1) == 0) {
                ...
                $.ajax({
                    ...
                    data: "idProduto=" + idProduto + "&idCompras=" + <?= $result->idCompras ?> + "&quantidade=" + quantidade + "&produto=" + produto,
                    dataType: 'json',
                    success: function(data) {
                        if (data.result == true) {
                            $("#divProdutos").load("<?php echo current_url(); ?> #divProdutos");
